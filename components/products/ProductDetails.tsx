...
const ProductDetails: FC<Props> = ({ product }) => {
    const { width: contentWidth } = useWindowDimensions(); // For RenderHtml contentWidth
            ...
            <ScrollView>
                ...
                <View>
                    <ProductImageCarousel
                        images={product.media?.map((m, idx) => ({ url: m.url, alt: m.alt, id: idx })) || []}
                    />
                </View>
                ...
                {description?.trim() ? (
                    <PaddedView style={styles.descriptionContainer}>
                        ...
                        <RenderHtml source={{ html: description }} contentWidth={contentWidth} />
                    </PaddedView>
                ) : <></>}
