...
const ProductDetailsSkeleton = () => {
  return (
    <View style={styles.container}>
        ...
        <PaddedView>
        <Skeleton colorMode="light" width="100%" height={250} radius={4} />
        </PaddedView>
        <PaddedView>
        <Skeleton colorMode="light" width="100%" height={30} radius={4} />
        </PaddedView>
        ...
        <Skeleton colorMode="light" width="60%" height={30} radius={4} />
        </PaddedView>
        <Divider style={{ borderBottomWidth: 5 }} />
        
        <PaddedView>
        <Skeleton colorMode="light" width="100%" height={40} radius={4} />
